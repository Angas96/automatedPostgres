...
psql -U postgres -d AutomatedPostgres -c "INSERT INTO countryMapping (lat, lon, zipcode, place, community) VALUES ($POSTGRES_LAT, $POSTGRES_LON, $POSTGRES_ZIPCODE, '$POSTGRES_CITY', '$POSTGRES_CITY')"
